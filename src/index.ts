...
//edad del paciente, conteo de pacientes, ultumas 5 recetas, citas de un doctor, citas de un paciente obtener doctores dispono¡bles para una fecha, obtener medicamentos de una receta, obtener el total de facturacion por mes 