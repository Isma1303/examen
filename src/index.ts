...
// MantenimientoDeProductos.actualizarProductoS(3,{stock:false})
// MantenimientoDeProductos.eliminarServicio(3)
...
// cancelarCita(1)
// programarCita(4, 1,"12-12-2024","100:10","El paciente necesita hacer limpieza general")
